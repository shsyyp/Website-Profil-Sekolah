...
<section class="mb-10 flex justify-between items-end">
    <div class="space-y-1">
        ...
        <p class="text-on-surface-variant text-lg">Perbarui informasi artikel yang sudah ada</p>
    </div>
</section>
...
<div class="bg-surface-container-lowest rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 max-w-4xl">
    ...
    {{-- Form Edit --}}
    {{-- Perhatikan penggunaan route('berita.update') dan @method('PUT') --}}
    <form action="{{ route('berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <select name="kategori"
                    ...
                    <option value="Pengumuman"
                        {{ (old('kategori', $berita->kategori) == 'Pengumuman') ? 'selected' : '' }}>Pengumuman</option>
                </select>
        ...
        <div>
            ...
            <div class="mb-3">
                ...
                <p class="text-xs text-on-surface-variant mt-1">Gambar saat ini. Biarkan kosong jika tidak ingin
                    mengubah.</p>
            </div>
            @endif
        ...
        <div class="pt-6 flex justify-end gap-4 border-t border-surface-container">
            ...
            <button type="submit"
                class="bg-primary text-on-primary px-8 py-3 rounded-xl font-bold shadow-lg hover:scale-105 transition-all">Update
                Berita</button>
        </div>
    </form>
</div>
