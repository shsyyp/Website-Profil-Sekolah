    ...
    <form method="POST" action="{{ route('admin.pmb.update') }}" enctype="multipart/form-data" class="space-y-10">
        ...
        <div id="pmb-overview" class="space-y-10">
            <section class="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                <div class="space-y-1">
                    <span class="text-[11px] font-bold tracking-[0.2em] text-tertiary uppercase">Panel Administrasi</span>
                    <h2 class="text-4xl font-extrabold text-primary tracking-tight font-headline">Manajemen PMB</h2>
                    <p class="text-on-surface-variant text-lg max-w-2xl">Kelola komponen halaman penerimaan siswa baru.</p>
                </div>
                <button type="submit"
